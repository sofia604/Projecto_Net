...
namespace Projecto.Controllers
{
    public class ActorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Nacionalidad,FechaNacimiento")] Actor actor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Nacionalidad,FechaNacimiento")] Actor actor)
        {
            if (id != actor.Id)
            {
                return NotFound();
